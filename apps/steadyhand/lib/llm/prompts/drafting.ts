...
- keywords: Relevant keywords from the JD woven in

For coverLetterParagraphs: Write 3-4 paragraphs for a cover letter.
- Opening: Hook connecting candidate to company/role
- Body 1-2: Highlight matching experiences with specific results
