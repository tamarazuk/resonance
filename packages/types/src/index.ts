...
export const createExperienceSchema = z.object({
  rawInput: z.string().min(10, "Experience description must be at least 10 characters"),
})

export const updateExperienceSchema = z.object({
  rawInput: z.string().min(10, "Experience description must be at least 10 characters").optional(),
